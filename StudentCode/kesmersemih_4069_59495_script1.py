...
suffix = 'slice_rezised_augment'


# dimensions of our images.
img_width, img_height = 150, 150

log_path = 'results/fc_model_' + suffix + '.log'
top_model_weights_path = 'weights/fc_model_' + suffix + '.h5'
train_data_dir = 'data/' + suffix + '/train'
validation_data_dir = 'data/' + suffix + '/validation'
nb_train_samples = 4959
nb_validation_samples = 1242
epochs = 50
batch_size = 64
